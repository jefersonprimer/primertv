      ...
      >
        <div>
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            Sua lista de animes favoritos salvos para assistir
          </p>
        </div>
        <Link
          href="/watchlist"
            ...
            >
              <div className="group flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1">
                  <Link href={cardHref}>
                    <h3 className="line-clamp-1 text-base font-semibold text-zinc-900 dark:text-zinc-100 hover:text-blue-500 transition-colors">
                      {item.title}
                    </h3>
                  </Link>
                  ...
                  {item.firstEpisodeId ? (
                    <Link
                      href={cardHref}
                      className="flex items-center gap-1.5 text-sm text-blue-500 font-medium hover:text-blue-600 transition-colors w-fit"
                    >
