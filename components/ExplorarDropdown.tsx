  ...
  return (
    <div className="relative flex h-full items-center" ref={dropdownRef}>
      <button
        ...
        aria-haspopup="true"
        className={`flex h-full items-center gap-1.5 px-4 text-sm font-medium text-[#bbb] hover:text-[#f2f2f2] transition-colors duration-200 hover:bg-[#151515] focus:outline-none ${
